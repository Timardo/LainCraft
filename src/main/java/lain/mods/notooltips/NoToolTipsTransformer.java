...
public class NoToolTipsTransformer implements IClassTransformer
{
    ...
    private byte[] transform001(byte[] bytes)
    {
        ...
        Set<String> methodDescs = Sets.newHashSet("(Lnet/minecraft/entity/player/EntityPlayer;Z)Ljava/util/List;", "(Lnet/minecraft/src/EntityPlayer;Z)Ljava/util/List;", "(Lwn;Z)Ljava/util/List;");

        Set<String> targetInsnOwners = Sets.newHashSet("net/minecraft/item/ItemStack", "net/minecraft/src/ItemStack", "zx");
        Set<String> targetInsnNames = Sets.newHashSet("func_111283_C", "B", "getAttributeModifiers");
